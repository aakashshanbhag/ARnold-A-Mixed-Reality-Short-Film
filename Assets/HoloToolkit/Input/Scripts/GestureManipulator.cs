...
namespace HoloToolkit.Unity
{
    ...
    public class GestureManipulator : MonoBehaviour
    {
        ...
        private void OnDisable()
        {
            ...
            Manipulating = false;
            this.SendMessage("EndManipulating", SendMessageOptions.DontRequireReceiver);
        }
        ...
        private void BeginManipulation(InteractionSourceKind sourceKind)
        {
            ...
            {
                if (GetComponent<cloudBehavior>().isSelected)
                {
                    Manipulating = true;
                    this.SendMessage("IsManipulating");
        ...
        {
            Manipulating = false;
            this.SendMessage("EndManipulating");
        }
